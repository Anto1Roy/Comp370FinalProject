...
def analyze_csv(input_csv, output_json):
    ...
    stats_dict = group_stats.set_index('category').to_dict(orient='index')
...
if __name__ == "__main__":
    ...
    output_json = os.path.join(os.path.dirname(__file__), '../data/articles/results/stats_per_category.json')
